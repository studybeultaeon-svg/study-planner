...
object RoutineQuotes {
    private val BROKEN = listOf(
        "오늘 루틴을 놓쳤어요. 연속 기록이 0으로 돌아갔습니다.",
        "어제까지 쌓은 연속 기록이 오늘 끊겼어요.",
        "연속 기록 초기화. 오늘부터 다시 시작하세요."
    )
    ...
    private val ZERO_MOCK = listOf(
        ...
        "연속 기록이 며칠째 0인데, 그것도 이제 습관이 되겠어요."
    )
