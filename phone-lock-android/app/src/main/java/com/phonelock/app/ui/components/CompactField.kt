...
/**
 * 96차: 사용자가 직접 그려준 시안을 그대로 옮긴 입력 칸. M3 OutlinedTextField의 애니메이션되는
 * "떠 있는 라벨" 대신, 라벨을 값 위에 작게 고정해서 보여주는 얇은 테두리 박스(시안 스크린샷 그대로).
...
/**
 * 96차: 시안의 "− 값 +" 스테퍼 박스. [CompactField]와 같은 테두리 박스 안에 감소/증가 텍스트를
 * 양 끝에 두고, 가운데 값은 BasicTextField라 탭해서 직접 숫자를 입력할 수도 있다(스테퍼 전용 아님).
 */
@Composable
