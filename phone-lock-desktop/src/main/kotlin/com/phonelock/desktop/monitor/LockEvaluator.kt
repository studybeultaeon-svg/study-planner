...
class LockEvaluator(private val repository: Repository) {
    ...
    fun isConfirmActiveNow(group: Group, now: LocalDateTime = LocalDateTime.now()): Boolean =
    ...
    fun isCurrentlyRestricting(group: Group, now: LocalDateTime = LocalDateTime.now()): Boolean {
