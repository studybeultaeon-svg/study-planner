 ...
 * 회유 멘트 20개를 하나씩 "예"를 눌러 끝까지 확인해야 실제로 종료된다(또는 79차부터, 이 확인 절차
 * 자체를 끄는 것도 같은 절차로 보호한다 — [title]로 문구만 바꿔 재사용). 각 단계는 눌렀을 때부터
...
fun ExitConfirmScreen(
    ...
    val baseLabel = if (isLast) finalLabel else "예"
