...
/**
 * ConfirmationGate 인메모리 쿨다운 최소 유닛테스트(82차, 감사 TOP20 20위/§14). [ConfirmationGate]는
 * 프로세스 전역 싱글턴이라 다른 테스트와 상태를 공유하지 않도록 각 테스트마다 다른 groupId를 쓴다.
 */
class ConfirmationGateTest {
    ...
    fun `remainingCooldownSeconds is close to full cooldown right after markConfirmed`() {
        ...
        assertTrue(remaining in 55..60, "expected remaining in 55..60 but was $remaining")
    }
